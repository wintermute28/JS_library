...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (evenrName, callback) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (evenrName, callback) {
  if (!evenrName || !callback) {
    return this;
  }
  for (let i = 0; i < this.length; i++) {
